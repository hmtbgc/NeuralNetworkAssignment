...
if __name__=="__main__":
    ...
    eval_dataset = VOCDataset(root_dir=r"E:\ZA\ZA\NN\mid-homework\dataset\VOCdevkit\VOC2007", resize_size=[800, 1333],
    ...
    model.load_state_dict(torch.load(r"checkpoint\best_model.pth",map_location=torch.device('cpu')))
