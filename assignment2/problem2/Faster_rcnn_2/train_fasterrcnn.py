...
def main(cfg):
    ...
    #wandb.login(key='591e5ee8e1156302583d892842cdeae32f2f44b3')
    wandb.init(project="Faster-rcnn", entity="Robert-Gu")
    ...
    for epoch in range(cfg.TRAIN.epochs):
        ...
        if sum(loss_list)/len(loss_list) < min_loss:
            ...
            torch.save(model.state_dict(),  Path(cfg.MODEL.saved_path)/cfg.MODEL.name/'model.pt')
