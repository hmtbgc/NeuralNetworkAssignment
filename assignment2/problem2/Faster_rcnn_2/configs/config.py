...
import numpy as np
_C.RANDOM_SEED = 44
_C.LOG_PATH = 'Faster-rcnn/logs/train.log'
# DATA config
_C.DATA = CN()
_C.DATA.name = 'VOC'
_C.DATA.dir = 'Faster-rcnn/dataset/VOCdevkit/VOC2007'
_C.DATA.width = 416
_C.DATA.height = 416
...
_C.MODEL.saved_path = './/Faster-rcnn/trained_model/'
_C.MODEL.pretrained_path = './/Faster-rcnn/trained_model/darknet53_backbone_weights.pth'
